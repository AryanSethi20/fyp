...
from subscriber_2 import EnhancedMQTTSubscriber
from environment_2 import AoIEnvironment, DQNAgent, TrainingMetrics, train_rl_agent, print_training_summary, DoubleDQNAgent, train_double_dqn_agent
...
def compare_agents(num_episodes=150, num_runs=3):
    ...
    for run in range(num_runs):
        ...
        try:
            ...
            double_dqn_rewards.append(double_dqn_metrics.episode_rewards)
    ...
    with open('agent_comparison_2.json', 'w') as f:
...
def plot_comparison(data):
    ...
    plt.tight_layout()
    plt.savefig('dqn_vs_double_dqn_2.png')
    plt.show()

def load_and_visualize_results(filename='agent_comparison_2.json'):
    """
